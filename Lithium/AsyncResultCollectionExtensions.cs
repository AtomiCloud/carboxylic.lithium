...
/// <summary>
/// Static class containing extension methods supporting collections of Async Results
/// </summary>
public static class AsyncResultCollectionExtensions
{
    ...
    public static async Task<IEnumerable<TSucc>> Get<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> collection
    )
        where TSucc : notnull
    {
    ...
    public static async IAsyncEnumerable<Exception> GetFailures<T>(
        this IEnumerable<Task<Result<T>>> collection
    )
        where T : notnull
    {
        await foreach (var result in collection.ToIAsyncEnumerable())
    ...
    public static async IAsyncEnumerable<T> GetSuccesses<T>(
        this IEnumerable<Task<Result<T>>> collection
    )
        where T : notnull
    {
    ...
    public static async Task<IEnumerable<Result<TSucc>>> AwaitAll<TSucc>(
    ...
    public static async Task<Result<TSucc>> AwaitAny<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> results
    )
    {
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Task<Result<TSucc>>> DoAwaitEach<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> results,
        DoType type,
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Task<Result<TSucc>>> DoEach<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> results,
        DoType type,
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Task<Result<Unit>>> ThenEach<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> results,
        Action<TSucc> function,
        ExceptionFilter mapException
    )
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Task<Result<TSucc>>> AssertEach<TSucc>(
        this IEnumerable<Task<Result<TSucc>>> results,
    ...
    public static IEnumerable<Task<TResult>> MatchAwaitEach<TSucc, TResult>(
        ...
        Func<Exception, Task<TResult>> Failure
    )
    {
    ...
    public static IEnumerable<Task<Result<TSucc>>> ToAsyncResultCollection<TSucc>(
    ...
    /// <returns>Collection of Async Results</returns>
    public static IEnumerable<Task<Result<TSucc>>> ToAsyncResultCollection<TSucc>(
        this IEnumerable<TSucc> results
    )
    {
        return results.Select(x => x.ToAsyncResult());
    }
