...
public static class ResultCollectionExtensions
{
    ...
    public static IEnumerable<TSucc> Get<TSucc>(this IEnumerable<Result<TSucc>> collection)
    {
        ...
        IEnumerable<Exception> failures = enumerable
            .GetFailures()
    ...
    {
        var enumerable = collection.ToList();
        IEnumerable<Exception> errors = enumerable.GetFailures().Where(x => x is not null)!;
    ...
    {
        return collection.Match(v => v.Select(r => new Result<T>(r)), e => [e]);
    }
    ...
    public static IEnumerable<Result<TSucc>> DoEach<TSucc, TResult>(
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Result<TSucc>> DoEach<TSucc>(
        this IEnumerable<Result<TSucc>> results,
        DoType type,
    ...
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Result<TResult>> ThenEach<TSucc, TResult>(
        this IEnumerable<Result<TSucc>> results,
        Func<TSucc, Result<TResult>> function
    )
    {
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Result<Unit>> ThenEach<TSucc>(
        this IEnumerable<Result<TSucc>> results,
        Action<TSucc> function,
        ExceptionFilter mapException
    )
    ...
    /// <typeparam name="TSucc">Input type</typeparam>
    /// <returns>Collection after executing function on each element</returns>
    public static IEnumerable<Result<TSucc>> AssertEach<TSucc>(
        this IEnumerable<Result<TSucc>> results,
