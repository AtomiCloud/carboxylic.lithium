...
public static class ResultLinqExtensions
{
    ...
    public static Result<TReturn> Select<TSucc, TReturn>(
        this Result<TSucc> result,
    ...
    /// <typeparam name="TReturn">Return type of function</typeparam>
    /// <returns>The Result of the computation</returns>
    public static Result<TReturn> SelectMany<TSucc, TReturn>(
        this Result<TSucc> result,
        Func<TSucc, Result<TReturn>> function
    )
        where TSucc : notnull
    ...
    /// <typeparam name="TReturn">Return type of function</typeparam>
    /// <returns>The Result of the computation</returns>
    public static Result<TReturn> SelectMany<TSucc, TMed, TReturn>(
        this Result<TSucc> result,
